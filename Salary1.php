...
<head>
    ...
    <style>#current{background-color: rgb(63, 63, 241);}
</style>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container">
                            ...
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: rgb(63, 63, 241);">Add Salary</button>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form accept="" method="post" action="salaryform.php">
                                              <h5 class="modal-title" id="exampleModalLabel" style="color: black; text-align: center; font-size: 25px;">Add EmpSalary</h5>
                                              <div class="modal-body">
                                                  <!-- <div class="">
                                                ...
                                                <div class="form">
                                                    <label id="l6" style="color: black;">workingDays</label>
                                                    <input type="number" name="workingdays" class="form-control" placeholder="No of workingDays">
                                                </div>
                                                <div class="form">
                                                    <label id="l6" style="color: black;">Total Amount</label>
                                                    <input type="text" name="totalamount" class="form-control" placeholder="Total Amount">
                                                </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='editSalary.php?id=" . $row['pno'] . "' class='btn btn-primary'>Edit</a></td>";
        
        // Add a "Delete" button/link
        echo "<td><a href='deleteSalary1.php?id=" . $row['pno'] . "' class='btn btn-danger'>Delete</a></td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
