                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="Home.html" data-toggle="modal" data-target="#logoutModal">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container">
                            ...
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: rgb(63, 63, 241);">Add Employee</button>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form accept="" method="post" action="form.php">
                                              <h5 class="modal-title" id="exampleModalLabel" style="color: black; text-align: center; font-size: 25px;">Add Employee</h5>
                                              <div class="modal-body">
                                                  <!-- <div class="">
                                                      <label id="l1" style="color: black;">No</label>
                                                      <input id ="t1" type="text" name="pno" class="form-control" placeholder="Enter NO">
                                                  </div> -->
                                                  <div class="form">
                                                      <label id="l2" style="color: black;">Name</label>
                                                      <input id ="t2" type="text" name="pname" class="form-control" placeholder="Enter your name">
                                                  </div>
                                                  <div class="form">
                                                      <label id="l3" style="color: black;">Age</label>
                                                      <input id ="t3" type="text" name="age" class="form-control" placeholder="Enter your age">
                                                  </div>
                                                  <div class="form">
                                                      <label id="l4" style="color: black;">Gender</label>
                                                      <input id ="t4" type="text" name="gender" class="form-control" placeholder="Enter your Gender">
                                                  </div>
                                                  <div class="form">
                                                    <label id="l5" style="color: black;">Address</label>
                                                    <input id ="t5" type="text" name="paddress" class="form-control" placeholder="Enter your address">
                                                </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='editEmployee1.php?id=" . $row['pno'] . "' class='btn btn-primary'>Edit</a></td>";      
        // Add a "Delete" button/link
        echo "<td><a href='deleteEmployee1.php?id=" . $row['pno'] . "' class='btn btn-danger'>Delete</a></td>";
