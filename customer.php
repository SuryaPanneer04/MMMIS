                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container">
                            ...
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: rgb(63, 63, 241);">Add Customer</button>
                                  ...
                                  <div class="modal-body">
                                    <form accept="" method="post" action="customerform.php">
                                              ...
                                              <div class="modal-body">
                                                  ...
                                                  <div class="form">
                                                      <label id="l3" style="color: black;">Address</label>
                                                      <input type="text" name="paddress" class="form-control" placeholder="Enter address ">
                                                  </div>
                                                  <div class="form">
                                                      <label id="l4" style="color: black;">Town</label>
                                                      <input type="text" name="town" class="form-control" placeholder="Enter Town">
                                                  </div>
                                                  <div class="form">
                                                    <label id="l5" style="color: black;">State</label>
                                                    <input type="text" name="pstate" class="form-control" placeholder="Enter State">
                                                </div>
                                                <div class="form">
                                                    <label id="l8" style="color: black;">Company Name</label>
                                                ...
                                                <div class="form">
                                                    <label id="l7" style="color: black;">Email</label>
