                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <div class="container">
                            ...
                            <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: rgb(63, 63, 241);">Add Attendance</button>
                              ...
                              <div class="modal-dialog">
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <form accept="" method="post" action="attendanceform.php">
                                              <h5 class="modal-title" id="exampleModalLabel" style="color: black; text-align: center; font-size: 25px;">Add Attendance</h5>
                                              <div class="modal-body">
                                                  <!-- <div class="">
                                                  ...
                                                  <div class="form">
                                                      ...
                                                      <input type="text" name="empno" class="form-control" placeholder="Enter empno">
                                                  </div>
                                                  <div class="form">
                                                      <label id="l3" style="color: black;">AttendanceDate</label>
                                                      <input type="date" name="attendancedate" class="form-control" placeholder="Enter AttendanceDate">
                                                  </div>
                                                  <div class="form">
                                                      <label id="l4" style="color: black;">CheckIn</label>
                                                      <input type="time" name="checkin" class="form-control" placeholder="CheckIn">
                                                  </div>
                                                  <div class="form">
                                                    <label id="l5" style="color: black;">CheckOut</label>
                                                    <input type="time" name="checkout" class="form-control" placeholder="CheckOut">
                                                </div>
...
if (mysqli_num_rows($result) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td><a href='editAttendance1.php?id=" . $row['pno'] . "' class='btn btn-primary'>Edit</a></td>";
        
        // Add a "Delete" button/link
        echo "<td><a href='deleteAttendance1.php?id=" . $row['pno'] . "' class='btn btn-danger'>Delete</a></td>";
        echo "</tr>";
    }
    echo "</tbody>";
    echo "</table>";
